...
struct RCC {
  __IO struct CR_bits       CR;            /*!< RCC clock control register,                                  Address offset: 0x00 */
  __IO struct PLLCFGR_bits  PLLCFGR;       /*!< RCC PLL configuration register,                              Address offset: 0x04 */
  __IO struct CFGR_bits     CFGR;          /*!< RCC clock configuration register,                            Address offset: 0x08 */
  ...
  __IO struct AHB1ENR_bits  AHB1ENR;       /*!< RCC AHB1 peripheral clock register,                          Address offset: 0x30 */
