...
typedef struct {
  volatile CR_bits      CR;            /*!< RCC clock control register,                                  Address offset: 0x00 */
  volatile PLLCFGR_bits PLLCFGR;       /*!< RCC PLL configuration register,                              Address offset: 0x04 */
  volatile CFGR_bits    CFGR;          /*!< RCC clock configuration register,                            Address offset: 0x08 */
  ...
  volatile AHB1ENR_bits AHB1ENR;       /*!< RCC AHB1 peripheral clock register,                          Address offset: 0x30 */
